...
function main() {
	...
	var tick = function() {
		...
		if(currentAngle>=1820 ) {
			...
			currentAngle = 0.0;
			document.getElementById('buttonSpin').removeAttribute('disabled');
		}
	...
	document.getElementById('buttonSpin').onclick = function(ev){
		document.getElementById('buttonSpin').setAttribute('disabled', true);
		click(ev, gl, canvas); 
		};
}
